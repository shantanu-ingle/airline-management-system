                ...
                script {
                    retry(5) {
                        timeout(time: 3, unit: 'MINUTES') {
                            ...
                            curl -v --retry 5 --retry-delay 10 --max-time 30 -X POST -H "Content-Type: application/json" -d "{\\"scheduleId\\":1,\\"passengerName\\":\\"John Doe\\",\\"passengerEmail\\":\\"john.doe@example.com\\",\\"seatNumber\\":\\"12A\\"}" http://13.220.119.113:8081/api/tickets
